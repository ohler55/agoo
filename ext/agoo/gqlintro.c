...
create_schema_type(agooErr err) {
	...
	NULL == gql_type_field(err, type, "types", type_list, NULL, 0, true, schema_types_resolve) ||
	NULL == gql_type_field(err, type, "queryType", type_type, NULL, 0, true, schema_query_type_resolve) ||
	NULL == gql_type_field(err, type, "mutationType", type_type, NULL, 0, false, NULL) ||
	NULL == gql_type_field(err, type, "subscriptionType", type_type, NULL, 0, false, NULL) ||
	NULL == gql_type_field(err, type, "directives", dir_list, NULL, 0, true, NULL)) {
...
create_type_type(agooErr err) {
	...
	NULL == gql_type_field(err, type, "kind", kind_type, NULL, 0, true, NULL) ||
	NULL == gql_type_field(err, type, "name", &gql_string_type, NULL, 0, false, NULL) ||
	NULL == gql_type_field(err, type, "description", &gql_string_type, NULL, 0, false, NULL) ||
	NULL == (fields = gql_type_field(err, type, "fields", field_list, NULL, 0, false, NULL)) ||
	NULL == gql_type_field(err, type, "interfaces", type_list, NULL, 0, false, NULL) ||
	NULL == gql_type_field(err, type, "possibleTypes", type_list, NULL, 0, false, NULL) ||
	NULL == (enum_values = gql_type_field(err, type, "enumValues", enum_list, NULL, 0, false, NULL)) ||
	NULL == gql_type_field(err, type, "inputFields", input_list, NULL, 0, false, NULL) ||
	NULL == gql_type_field(err, type, "ofType", type, NULL, 0, false, NULL)) {
...
create_field_type(agooErr err) {
	...
	NULL == gql_type_field(err, type, "name", &gql_string_type, NULL, 0, true, NULL) ||
	NULL == gql_type_field(err, type, "description", &gql_string_type, NULL, 0, false, NULL) ||
	NULL == gql_type_field(err, type, "args", input_list, NULL, 0, true, NULL) ||
	NULL == gql_type_field(err, type, "type", type_type, NULL, 0, true, NULL) ||
	NULL == gql_type_field(err, type, "isDeprecated", &gql_bool_type, NULL, 0, true, NULL) ||
	NULL == gql_type_field(err, type, "reason", &gql_string_type, NULL, 0, false, NULL)) {
...
create_input_type(agooErr err) {
	...
	NULL == gql_type_field(err, type, "description", &gql_string_type, NULL, 0, false, NULL) ||
	NULL == gql_type_field(err, type, "type", type_type, NULL, 0, true, NULL) ||
	NULL == gql_type_field(err, type, "defaultValue", &gql_string_type, NULL, 0, false, NULL)) {
...
create_enum_type(agooErr err) {
	...
	NULL == gql_type_field(err, type, "description", &gql_string_type, NULL, 0, false, NULL) ||
	NULL == gql_type_field(err, type, "isDeprecated", &gql_bool_type, NULL, 0, true, NULL) ||
	NULL == gql_type_field(err, type, "deprecationReason", &gql_string_type, NULL, 0, false, NULL)) {
...
create_directive_type(agooErr err) {
	...
	NULL == gql_type_field(err, type, "name", &gql_string_type, NULL, 0, true, NULL) ||
	NULL == gql_type_field(err, type, "description", &gql_string_type, NULL, 0, false, NULL) ||
	NULL == gql_type_field(err, type, "location", loc_list, NULL, 0, true, NULL) ||
	NULL == gql_type_field(err, type, "args", input_list, NULL, 0, true, NULL)) {
